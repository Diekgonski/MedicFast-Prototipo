...
<html lang="es">
    ...
    <head>
        ...
        <title>MedicFast | Medicamentos</title>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container py-3">
                    <a href="SolicitudMedicamentoView.php" class="btn btn-primary float-right">Solicitar Medicamentos</a>
                    <?php
                    if($_SESSION['sesionUser'][1] === "1")
                    {
                        echo '<a href="ControlMedicamentoView.php" class="btn btn-primary float-right mr-2">Agregar Medicamentos</a>';
                    }
                    ?>        
                </div>


                <section class="container medicamentos mt-4">
