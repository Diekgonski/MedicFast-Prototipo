...
<html lang="es">
    ...
    <head>
        ...
        <title>MedicFast | Solicitar Medicamentos</title>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container">
                    <section class="py-3">
                        <div class="container">
                                <a class="btn btn-primary float-right mr-2" href="MedicamentoView.php">Atrás</a>
                            </div>
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Número de orden..." aria-label="Recipient's username" aria-describedby="button-addon2" id="orden">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" onclick="solicitarMedicamento()" id="button-addon2">Buscar</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <div id="tablaSoliticarMedicamentos">
